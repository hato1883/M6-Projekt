...
class NarrationInterface(ABC):
    ...
    @abstractmethod
    def generate_move_text(origin: Position, destination: Position, moved_piece: ChessPiece, attacked_piece: ChessPiece) -> str:
        """Generates a description for the given move

        Inputs:
        origin - Position object of moved piece starting row and column
        destination - Position object of containing destination row and column of the moved piece
        moved_piece - ChessPiece object of what piece got moved
        attacked_piece - ChessPiece object of what piece got killed in move. Can be None
